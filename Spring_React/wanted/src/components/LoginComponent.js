...
const LoginComponent = (props) => {
  ...
  const emailOnChange = (e) => {
    ...
    setEmailBoolean(Effectiveness.emailEffectiveness(isEmail));
  };

  useEffect(() => {
    if (isEmail === "") {
      setEmailInputStyle("Login_Email_input_grayBorder");
    } else {
      emailBoolean
  ...
  function emailWrongText() {
    if (emailBoolean === false) {
      return (
        <span className="Login_Input_WrongText">
          올바른 이메일을 입력해주세요.
        </span>
      );
    } else {
  ...
  return (
    <div className="Login_Div_Div">
      <div className="Login_LogoSvg_Div">
        <svg viewBox="0 0 343 43" className="Login_Title_svg">
          <path
        ...
        <div className="Login_Body_Div_Div">
          ...
          <div className="Login_Email_Div">
            ...
            <input
              ...
              value={isEmail}
              className={`Login_Email_input ${emailInputStyle}`}
              type="email"
            ></input>
            {emailWrongText()}
          </div>
          <button
            disabled={emailBoolean ? "" : "disabled"}
          ...
          <ul className="Login_Icons">
            <li className="Login_Icon">
              <button>
                <svg viewBox="0 0 57 56" className="Login_Icon_Style">
                  <path
